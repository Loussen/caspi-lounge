        ...
        if ( $this->request->server['REQUEST_METHOD'] == 'POST' )
        {
            ...
            foreach ($this->request->post['manufacturer_seo_url'] as $store_id => $language)
            {
                foreach ($language as $language_id => $keyword)
                {
                    ...
                    if ( empty($keyword) && !empty($this->request->post['manufacturer_description'][$this->config->get('config_language_id')]['name']) ) {
                        $keyword = autocrateseourls( trim($this->request->post['manufacturer_description'][$this->config->get('config_language_id')]['name']) );
                    } else {
