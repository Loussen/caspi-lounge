...
//            echo "</pre>";
            ...
            foreach ($this->request->post['information_seo_url'] as $store_id => $language)
            {
                foreach ($language as $language_id => $keyword)
                {
                    ...
                    if ( empty($keyword) && !empty($this->request->post['information_description'][$this->config->get('config_language_id')]['title']) ) {
                        $keyword = autocrateseourls( trim($this->request->post['information_description'][$this->config->get('config_language_id')]['title']) );
                    } else {
