...
//            print_r( $totalproducts );
            ...
            if (isset($this->request->get['filter_manufacturer'])) {
                $data['filter_manufacturer'] = (int)$this->request->get['filter'];
            } else {
                $data['filter_manufacturer'] = 0;
            }
            ...
            $manufacturer_list = $this->model_catalog_manufacturer->getManufacturers();

            $data['manufacturers'] = array();
            foreach ($manufacturer_list as $manufacturers) {
                $data['manufacturers'][$manufacturers['manufacturer_id']] = $manufacturers['name'];
            }
