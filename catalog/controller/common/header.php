...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['author'] = $this->config->get('config_owner');
		...
		$data['payment'] = $this->url->link('information/information', 'information_id=7' );
		$data['services'] = $this->url->link('information/information', 'information_id=8' );
        ...
        $data['header_email'] = $this->config->get('config_email');
